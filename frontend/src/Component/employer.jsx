...
const Employer = ({ onAuthentication }) => {
  return (
    <div>
        ...
        <div className='row g-0'><button className='btn btn-danger logout d-flex' onClick={()=>onAuthentication(null)}><i class="bi bi-box-arrow-right d-block pe-2"></i>Logout</button>
            <div className='col-2'>
