...
export default function Candiate_status () {
  ...
  return (
    ...
    <div className="main-bg2 text-white employer_profile d-flex justify-content-center flex-column align-items-center  h-100vh px-3 overflow-hidden">
      <div className="col-md-11 p-4 rounded-3 opacity">
        <h2 className="py-2 text-center " style={{"font-family":" cursive"}}>Candiate Status</h2>
        <div className=" text-end"><Link to={"/"} className=" text-decoration-none fw-semibold">Add Jobs <i class="bi bi-arrow-right"></i></Link></div>
