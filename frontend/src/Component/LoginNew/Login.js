  ...
  return (
    <div className="col-8 mx-auto py-5 main" style={{ height: "100vh" }}>
      <div className="row login  h-100">
        <div className=" text-black rounded-start-3 col-md-6 bg-white h-100 align-items-center d-flex flex-column justify-content-center position-relative overflow-hidden">
        ...
        <div
          className="rounded-end-3 col-md-6 text-white h-100 align-items-center d-flex flex-column justify-content-center"
