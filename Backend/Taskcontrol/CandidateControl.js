...
const CandidategetMethod = async (req, res) => {
  try {
...
// gettingid:
const CandidategettingIdmethod = async (req, res) => {
  const { id } = req.params;
  try {
...
const Candidateputmethod = async (req, res) => {
  const { id } = req.params;
...
const Candidatedeletemethod = async (req, res) => {
  const { id } = req.params;
  try {
